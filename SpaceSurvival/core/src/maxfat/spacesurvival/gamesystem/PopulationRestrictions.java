...
public class PopulationRestrictions {
	...
	public static final IntRange Reproduction = new IntRange(0, 10);
	public static final IntRange FoodProduction = new IntRange(0, 10);

	public static final IntRange GoldProduction = new IntRange(0, 10);
